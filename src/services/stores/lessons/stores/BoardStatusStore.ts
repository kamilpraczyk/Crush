...
import { BoardAnswerStore, BoardAnswerState } from './BoardAnswerStore';
...
class BoardStatusStore {
    activeIndex: number = 0;
    lesson: LessonFace = null;
    mapStatus: MapStatus = {};
    public boardAnswerStore: BoardAnswerStore;
    ...
    private getCurrentBoard() {
        return this.lesson.boards[this.activeIndex];
    }

    generateNewBoardQuery() {
        this.boardAnswerStore = new BoardAnswerStore(this.getCurrentBoard());
    }
